...
module.exports = {
  ...
  up: async (knex) => {
    ...
    await knex.schema.createTable(tables.difficulty, (table) => {
      ...
      table.unique('name', 'idx_difficulty_name_unique'); // unique constraint op name
    });
  },
  // migratie ongedaan maken
  down: async (knex) => {
    await knex.schema.dropTableIfExists(tables.difficulty);
  },
};